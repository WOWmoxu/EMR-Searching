...
condition_str = '{"necessary_condition":{"all":{"姓名":[],"性别":[["男性"],["女性"]],"年龄":[["<50"],[">20"]],"部位对应症状":[["左上肢","水肿","疼痛"],["骶尾部皮肤","破溃","流脓"]],"精神特征对应结果":[],"生理特征对应结果":[],"生理指标对应数值":[["体温",">37.0","<30","<36.0"]],"肯定症状":[["小儿偏头痛","典型偏头痛","颅内偏头痛","面下部头痛","偏头痛","额颞部头痛","颅外头痛","全头痛","头痛"],["头晕"],["恶心"],["呕吐"]],"肯定疾病":[["先天性心脏病"],["脑震荡"]],"肯定手术治疗":[],"肯定非手术治疗":[],"肯定药品名":[["布洛芬"]]},"zs":{"时间":[],"肯定症状":[],"否定症状":[],"部位对应症状":[]},"xbs":{"否定症状":[],"否定疾病":[],"否定手术治疗":[],"否定非手术治疗":[],"否定药品":[],"科室":[],"部位对应症状":[],"精神特征对应结果":[],"生理特征对应结果":[],"生理指标对应数量":[],"肯定症状":[["头痛"],["头晕"],["恶心"],["呕吐"]],"肯定疾病":[],"肯定手术治疗":[],"肯定非手术治疗":[],"肯定药品名":[]}},"sufficient_condition":{"all":{"姓名":[],"性别":[],"年龄":[],"否定症状":[],"否定疾病":[],"否定手术治疗":[],"否定非手术治疗":[],"否定药品":[],"科室":[],"部位对应症状":[],"精神特征对应结果":[],"生理特征对应结果":[],"生理指标对应数量":[],"肯定症状":[["头痛"],["头晕"],["恶心"],["呕吐"]],"肯定疾病":[],"肯定手术治疗":[],"肯定非手术治疗":[],"肯定药品名":[]},"zs":{"时间":[],"肯定症状":[],"否定症状":[],"部位对应症状":[]},"xbs":{"否定症状":[],"否定疾病":[],"否定手术治疗":[],"否定非手术治疗":[],"否定药品":[],"科室":[],"部位对应症状":[],"精神特征对应结果":[],"生理特征对应结果":[],"生理指标对应数量":[],"肯定症状":[["头痛"],["头晕"],["恶心"],["呕吐"]],"肯定疾病":[],"肯定手术治疗":[],"肯定非手术治疗":[],"肯定药品名":[]}}}'
...
def get_condition(condition_str):
    ...
    condition_object = json.loads(condition_str)
...
def parse_condition(condition_object):
    ...
    :return:
    """
    necessary_condition = condition_object['necessary_condition']
    sufficient_condition = condition_object['sufficient_condition']
...
def parse_nc():
    ...
    grs = necessary_condition['grs']  # 个人史条件

    # 获取过滤后的条件
    all_conditions = filter_condition(all)
    zs_conditions = filter_condition(zs)
    xbs_conditions = filter_condition(xbs)
    grs_conditions = filter_condition(grs)

    return all_conditions, zs_conditions, xbs_conditions, grs_conditions
